...
<title>Tracking Order Status</title>
<style>
	...
	<div align="center" class="main">
		<table align="center">
			...
			try {
				...
				ResultSet rs = st.executeQuery("select * from orderdetails where Userid='" + userid + "'");
			%>
         <!--viewing orderdata from orderdetails table-->
			<%
			while (rs.next()) {
			%>
			<tr align="center">
		...
		<br> <br><br><br>
		<button onclick="location.href='Customerhome.jsp'">Back to Home</button>
